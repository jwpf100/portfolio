const inputData = {
  experienceArray: [
    ...
    {
      year: '2016 – 2019',
      title: 'Director of EU E-Commerce',
    ...
    {
      year: '2011 - 2015',
      title: 'Senior Management Positions - Finance and Operations ',
      company: 'Wolverine Worldwide',
      country: '',
      text: [
    ...
    // {
    //   year: '2007 - 2011',
    //   title: 'Arcadia Finance Graduate Scheme',
    //   company: 'Arcadia Group',
    //   country: '',
    //   text: [
    //     'Graduate scheme giving in depth experience of the financial management of a retail business',
    //   ],
    // },
    // {
    //   year: '2006 - 2007',
    ...
    //   country: '',
    //   text: [
    //     'Responsible for all Management Information, dashboard reporting and responsible for a number of projects to improve performance in stores',
    //   ],
    // },
  ],
}
